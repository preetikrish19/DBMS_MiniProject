...
include('db.php');
$i=1;
$sql = "SELECT DISTINCT enrolldetails.uid, enrolldetails.name, enrolldetails.year, enrolldetails.email FROM enrolldetails 
INNER JOIN chat ON chat.student_id=enrolldetails.uid  
WHERE enrolldetails.uid NOT IN( SELECT DISTINCT f.uid FROM follow f WHERE f.mid=$_SESSION[mid]) AND chat.mentor_id=$_SESSION[mid]";
...
//$sql2 = "SELECT DISTINCT e.uid, e.name,e.email,e.year from enrolldetails e WHERE e.uid NOT IN( SELECT DISTINCT f.uid FROM follow f) INNER JOIN chat ON chat.student_id=e.uid";
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item bg-dark" href="#" style="color: white">Unfollow</a>
        </div>
      </li>
    <li class="nav-item">
